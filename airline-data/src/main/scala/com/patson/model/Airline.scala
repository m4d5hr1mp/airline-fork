...
object AirlineGrade {
  ...
  val LESSER_INTERNATIONAL = AirlineGrade(6, 120, "Lesser International Airline")
  val THIRD_INTERNATIONAL = AirlineGrade(7, 140, "Third-class International Airline")
  val SECOND_INTERNATIONAL = AirlineGrade(8, 160, "Second-class International Airline")
  val MAJOR_INTERNATIONAL = AirlineGrade(9, 180, "Major International Airline")
  val TOP_INTERNATIONAL = AirlineGrade(10, 200, "Top International Airline")
  val TOP_INTERNATIONAL_2 = AirlineGrade(11, 225, "Top International Airline II")
  val TOP_INTERNATIONAL_3 = AirlineGrade(12, 250, "Top International Airline III")
  val TOP_INTERNATIONAL_4 = AirlineGrade(13, 300, "Top International Airline IV")
  val TOP_INTERNATIONAL_5 = AirlineGrade(14, 350, "Top International Airline V")
  val EPIC = AirlineGrade(15, 400, "Epic Airline")
  val ULTIMATE = AirlineGrade(16, 500, "Ultimate Airline")
