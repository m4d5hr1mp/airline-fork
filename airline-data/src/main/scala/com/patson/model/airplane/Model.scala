...
object Model {
  ...
  val models = List(
    Model("Vickers Viscount 700", "Vickers Viscount", capacity = 53, fuelBurn = (1275 / 60).toInt, speed = 521, range = 2140, price = 10_500_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Vickers", countryCode = "GB"), runwayRequirement = 1360, imageUrl = ""),
    Model("Lisunov Li-2", "Lisunov Li-2", capacity = 32, fuelBurn = (304 / 60).toInt, speed = 335, range = 2400, price = 5_000_000, lifespan = 25 * 52, constructionTime = 0, Manufacturer("Lisunov", countryCode = "RU"), runwayRequirement = 768, imageUrl = ""),
    Model("Douglas DC-3", "Douglas DC-3", capacity = 32, fuelBurn = (304 / 60).toInt, speed = 335, range = 2400, price = 5_000_000, lifespan = 25 * 52, constructionTime = 0, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 768, imageUrl = ""),
    Model("Lockheed L-749 Constellation", "Lockheed Constellation", capacity = 60, fuelBurn = (1200 / 60).toInt, speed = 497, range = 4832, price = 13_400_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Lockheed", countryCode = "US"), runwayRequirement = 1113, imageUrl = ""),
    Model("Lockheed L-749A Constellation", "Lockheed Constellation", capacity = 87, fuelBurn = (1200 / 60).toInt, speed = 497, range = 5917, price = 15_560_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Lockheed", countryCode = "US"), runwayRequirement = 1244, imageUrl = ""),
    Model("Lockheed L-1049 Super Constellation", "Lockheed Constellation", capacity = 80, fuelBurn = (1229 / 60).toInt, speed = 515, range = 6146, price = 16_640_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Lockheed", countryCode = "US"), runwayRequirement = 1199, imageUrl = ""),
    Model("Lockheed L-1049C Super Constellation", "Lockheed Constellation", capacity = 86, fuelBurn = (1034 / 60).toInt, speed = 525, range = 8143, price = 17_720_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Lockheed", countryCode = "US"), runwayRequirement = 1435, imageUrl = ""),
    Model("Lockheed L-1049G Super Constellation", "Lockheed Constellation", capacity = 110, fuelBurn = (1034 / 60).toInt, speed = 525, range = 8956, price = 18_800_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Lockheed", countryCode = "US"), runwayRequirement = 1525, imageUrl = ""),
    Model("Lockheed L-1649 Starliner", "Lockheed Constellation", capacity = 134, fuelBurn = (1194 / 60).toInt, speed = 563, range = 9275, price = 34_400_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Lockheed", countryCode = "US"), runwayRequirement = 1768, imageUrl = ""),
    Model("Douglas DC-6", "Douglas DC-6/DC-7", capacity = 60, fuelBurn = (1271 / 60).toInt, speed = 501, range = 5605, price = 13_000_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1406, imageUrl = ""),
    Model("Douglas DC-6B", "Douglas DC-6/DC-7", capacity = 70, fuelBurn = (1271 / 60).toInt, speed = 501, range = 5921, price = 14_500_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1590, imageUrl = ""),
    Model("Douglas DC-7", "Douglas DC-6/DC-7", capacity = 74, fuelBurn = (1040 / 60).toInt, speed = 587, range = 8430, price = 17_800_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1739, imageUrl = ""),
    Model("Douglas DC-7C", "Douglas DC-6/DC-7", capacity = 112, fuelBurn = (1085 / 60).toInt, speed = 591, range = 9681, price = 20_700_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1947, imageUrl = ""),
    Model("Boeing 377 Stratocruiser", "Boeing 377", capacity = 75, fuelBurn = (2039 / 60).toInt, speed = 565, range = 6049, price = 15_500_000, lifespan = 35 * 52, constructionTime = 4, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1676, imageUrl = ""),
    Model("Convair CV-240", "Convair CV-240/340/400", capacity = 40, fuelBurn = (624 / 60).toInt, speed = 432, range = 1330, price = 6_000_000, lifespan = 30 * 52, constructionTime = 0, Manufacturer("Convair", countryCode = "US"), runwayRequirement = 790, imageUrl = ""),
    Model("Convair CV-340", "Convair CV-240/340/400", capacity = 52, fuelBurn = (714 / 60).toInt, speed = 460, range = 2330, price = 7_500_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Convair", countryCode = "US"), runwayRequirement = 798, imageUrl = ""),
    Model("Convair CV-440", "Convair CV-240/340/400", capacity = 60, fuelBurn = (714 / 60).toInt, speed = 460, range = 1521, price = 9_500_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Convair", countryCode = "US"), runwayRequirement = 904, imageUrl = ""),
    Model("Vickers Viscount 800", "Vickers Viscount", capacity = 65, fuelBurn = (1380 / 60).toInt, speed = 565, range = 2780, price = 12_000_000, lifespan = 35 * 52, constructionTime = 4, Manufacturer("Vickers-Armstrong", countryCode = "GB"), runwayRequirement = 1650, imageUrl = ""),
    Model("Vickers Viscount 810", "Vickers Viscount", capacity = 75, fuelBurn = (1468 / 60).toInt, speed = 565, range = 2780, price = 12_500_000, lifespan = 35 * 52, constructionTime = 4, Manufacturer("Vickers-Armstrong", countryCode = "GB"), runwayRequirement = 1700, imageUrl = ""),
    Model("Vickers Viking", "Vickers Viking", capacity = 36, fuelBurn = (735 / 60).toInt, speed = 338, range = 2740, price = 6_500_000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Vickers-Armstrong", countryCode = "GB"), runwayRequirement = 1234, imageUrl = ""),
    Model("Ilyushin Il-18", "Ilyushin Il-18", capacity = 120, fuelBurn = (2350 / 60).toInt, speed = 625, range = 4300, price = 15_200_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 1300, imageUrl = ""),
    Model("Antonov An-10", "Antonov Props", capacity = 84, fuelBurn = (2900 / 60).toInt, speed = 680, range = 1200, price = 12_500_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Antonov", countryCode = "UA"), runwayRequirement = 1300, imageUrl = ""),
    Model("Antonov An-24", "Antonov Props", capacity = 55, fuelBurn = (1500 / 60).toInt, speed = 459, range = 1000, price = 7_850_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Antonov", countryCode = "UA"), runwayRequirement = 900, imageUrl = ""),
    Model("Xian Y-7", "Xian Props", capacity = 55, fuelBurn = (1500 / 60).toInt, speed = 459, range = 1000, price = 7_850_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Xian", countryCode = "CN"), runwayRequirement = 900, imageUrl = ""),
    Model("Handley Page HP81 Hermes", "Handley Page HP81", capacity = 75, fuelBurn = (831 / 60).toInt, speed = 441, range = 3610, price = 13_400_000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Handley Page", countryCode = "GB"), runwayRequirement = 1030, imageUrl = ""),
    Model("Boeing 707-120", "Boeing 707", capacity = 174, fuelBurn = (6605 / 60).toInt, speed = 880, range = 5021, price = 55_700_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2628, imageUrl = ""),
    Model("DeHaviland Comet 4", "DeHaviland Comet", capacity = 81, fuelBurn = (4145 / 60).toInt, speed = 725, range = 5255, price = 35_700_000, lifespan = 35 * 52, constructionTime = 6, Manufacturer("DeHaviland", countryCode = "GB"), runwayRequirement = 2065, imageUrl = ""),
    Model("Sud-Aviation Caravelle I", "Sud-Aviation Caravelle", capacity = 80, fuelBurn = (3411 / 60).toInt, speed = 725, range = 1842, price = 27_700_000, lifespan = 30 * 52, constructionTime = 6, Manufacturer("Sud-Aviation", countryCode = "FR"), runwayRequirement = 2184, imageUrl = ""),
    Model("Boeing 707-320", "Boeing 707", capacity = 189, fuelBurn = (7107 / 60).toInt, speed = 876, range = 7228, price = 59_800_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 3202, imageUrl = ""),
    Model("Douglas DC-8-10", "Douglas DC-8", capacity = 179, fuelBurn = (6525 / 60).toInt, speed = 830, range = 6386, price = 55_300_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 2875, imageUrl = ""),
    Model("Douglas DC-8-21", "Douglas DC-8", capacity = 179, fuelBurn = (6376 / 60).toInt, speed = 865, range = 7090, price = 58_500_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 2417, imageUrl = ""),
    Model("Douglas DC-8-33", "Douglas DC-8", capacity = 179, fuelBurn = (6426 / 60).toInt, speed = 880, range = 9571, price = 75_500_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 2893, imageUrl = ""),
    Model("DeHaviland Comet 4B", "DeHaviland Comet", capacity = 86, fuelBurn = (4619 / 60).toInt, speed = 785, range = 4503, price = 35_700_000, lifespan = 30 * 52, constructionTime = 6, Manufacturer("DeHaviland", countryCode = "GB"), runwayRequirement = 1849, imageUrl = ""),
    Model("Convair CV-880", "Convair CV-880/990", capacity = 110, fuelBurn = (5053 / 60).toInt, speed = 871, range = 5259, price = 53_800_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Convair", countryCode = "US"), runwayRequirement = 2333, imageUrl = ""),
    Model("Convair CV-880M", "Convair CV-880/990", capacity = 124, fuelBurn = (5063 / 60).toInt, speed = 893, range = 5508, price = 54_400_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Convair", countryCode = "US"), runwayRequirement = 2293, imageUrl = ""),
    Model("Sud-Aviation Caravelle III", "Sud-Aviation Caravelle", capacity = 90, fuelBurn = (3465 / 60).toInt, speed = 725, range = 2341, price = 32_200_000, lifespan = 30 * 52, constructionTime = 6, Manufacturer("Sud-Aviation", countryCode = "FR"), runwayRequirement = 1832, imageUrl = ""),
    Model("Boeing 720", "Boeing 707", capacity = 149, fuelBurn = (6057 / 60).toInt, speed = 880, range = 5616, price = 54_400_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2764, imageUrl = ""),
    Model("DeHaviland Comet 4C", "DeHaviland Comet", capacity = 101, fuelBurn = (4970 / 60).toInt, speed = 785, range = 4372, price = 50_700_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("DeHaviland", countryCode = "GB"), runwayRequirement = 2006, imageUrl = ""),
    Model("Boeing 707-120B", "Boeing 707", capacity = 174, fuelBurn = (5758 / 60).toInt, speed = 880, range = 6331, price = 59_200_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2452, imageUrl = ""),
    Model("Boeing 720B", "Boeing 707", capacity = 156, fuelBurn = (5358 / 60).toInt, speed = 897, range = 6050, price = 64_000_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1895, imageUrl = ""),
    Model("Sud-Aviation Caravelle VI", "Sud-Aviation Caravelle", capacity = 99, fuelBurn = (3636 / 60).toInt, speed = 725, range = 2788, price = 34_500_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Sud-Aviation", countryCode = "FR"), runwayRequirement = 1947, imageUrl = ""),
    Model("Convair CV-990A", "Convair CV-880/990", capacity = 149, fuelBurn = (6389 / 60).toInt, speed = 917, range = 5204, price = 58_600_000, lifespan = 30 * 52, constructionTime = 12, Manufacturer("Convair", countryCode = "US"), runwayRequirement = 2636, imageUrl = ""),
    Model("Boeing 707-320B", "Boeing 707", capacity = 189, fuelBurn = (6341 / 60).toInt, speed = 886, range = 9429, price = 85_300_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 3291, imageUrl = ""),
    Model("Tupolev Tu-124", "Tupolev Tu-124", capacity = 71, fuelBurn = (4702 / 60).toInt, speed = 850, range = 3178, price = 15_800_000, lifespan = 30 * 52, constructionTime = 6, Manufacturer("Tupolev", countryCode = "RU"), runwayRequirement = 1563, imageUrl = ""),
    Model("Douglas DC-8-53", "Douglas DC-8", capacity = 189, fuelBurn = (6472 / 60).toInt, speed = 880, range = 9338, price = 70_000_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 2827, imageUrl = ""),
    Model("Boeing 727-100", "Boeing 727", capacity = 131, fuelBurn = (5160 / 60).toInt, speed = 960, range = 3881, price = 44_700_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1508, imageUrl = ""),
    Model("Vickers VC-10 Type 1101", "Vickers VC-10", capacity = 151, fuelBurn = (7269 / 60).toInt, speed = 886, range = 7464, price = 67_500_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("BAC", countryCode = "GB"), runwayRequirement = 2162, imageUrl = ""),
    Model("Sud-Aviation Caravelle 10B", "Sud-Aviation Caravelle", capacity = 104, fuelBurn = (3763 / 60).toInt, speed = 800, range = 2670, price = 41_500_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Sud-Aviation", countryCode = "FR"), runwayRequirement = 1464, imageUrl = ""),
    Model("BAC One-Eleven 200", "BAC One-Eleven", capacity = 89, fuelBurn = (3100 / 60).toInt, speed = 830, range = 2162, price = 62_700_000, lifespan = 35 * 52, constructionTime = 6, Manufacturer("BAC", countryCode = "GB"), runwayRequirement = 1423, imageUrl = ""),
    Model("Douglas DC-9-10", "Douglas DC-9", capacity = 90, fuelBurn = (2280 / 60).toInt, speed = 930, range = 3150, price = 35_800_000, lifespan = 35 * 52, constructionTime = 6, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1411, imageUrl = ""),
    Model("BAC One-Eleven 300", "BAC One-Eleven", capacity = 89, fuelBurn = (2782 / 60).toInt, speed = 830, range = 2565, price = 59_800_000, lifespan = 35 * 52, constructionTime = 6, Manufacturer("BAC", countryCode = "GB"), runwayRequirement = 1981, imageUrl = ""),
    Model("Douglas DC-9-30", "Douglas DC-9", capacity = 130, fuelBurn = (2650 / 60).toInt, speed = 817, range = 2450, price = 38_600_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1317, imageUrl = ""),
    Model("Douglas DC-8-61", "Douglas DC-8", capacity = 259, fuelBurn = (6464 / 60).toInt, speed = 845, range = 6847, price = 112_750_000, lifespan = 35 * 52, constructionTime = 18, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 2862, imageUrl = ""),
    Model("Douglas DC-8-62", "Douglas DC-8", capacity = 189, fuelBurn = (6304 / 60).toInt, speed = 845, range = 9317, price = 83_500_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 2808, imageUrl = ""),
    Model("Douglas DC-8-63", "Douglas DC-8", capacity = 259, fuelBurn = (6986 / 60).toInt, speed = 880, range = 8095, price = 120_750_000, lifespan = 35 * 52, constructionTime = 18, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 3418, imageUrl = ""),
    Model("Tupolev Tu-134", "Tupolev Tu-134", capacity = 92, fuelBurn = (2482 / 60).toInt, speed = 870, range = 2600, price = 29_500_000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Tupolev", countryCode = "RU"), runwayRequirement = 1117, imageUrl = ""),
    Model("Ilyushin Il-62", "Ilyushin Il-62", capacity = 186, fuelBurn = (7068 / 60).toInt, speed = 850, range = 7883, price = 59_750_000, lifespan = 30 * 52, constructionTime = 12, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 2817, imageUrl = ""),
    Model("Boeing 727-200", "Boeing 727", capacity = 189, fuelBurn = (5846 / 60).toInt, speed = 920, range = 3137, price = 53_000_000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2502, imageUrl = ""),
    Model("Douglas DC-9-40", "Douglas DC-9", capacity = 135, fuelBurn = (2560 / 60).toInt, speed = 817, range = 3120, price = 50_100_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Douglas Corporation", countryCode = "US"), runwayRequirement = 1457, imageUrl = ""),
    Model("Boeing 737-100", "Boeing 737 Original", capacity = 120, fuelBurn = (3888 / 60).toInt, speed = 890, range = 3185, price = 34_200_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1981, imageUrl = ""),
    Model("Boeing 737-200", "Boeing 737 Original", capacity = 132, fuelBurn = (2820 / 60).toInt, speed = 890, range = 4306, price = 37_000_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2097, imageUrl = ""),
    Model("BAC One-Eleven 500", "BAC One-Eleven", capacity = 119, fuelBurn = (3450 / 60).toInt, speed = 742, range = 2745, price = 62_700_000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("BAC", countryCode = "GB"), runwayRequirement = 1981, imageUrl = ""),
    Model("Fokker F28 Fellowship", "Fokker F28", capacity = 80, fuelBurn = (2289 / 60).toInt, speed = 666, range = 2602, price = 26_300_000, lifespan = 30 * 52, constructionTime = 6, Manufacturer("Fokker", countryCode = "NL"), runwayRequirement = 1320, imageUrl = ""),
    Model("Boeing 747-100", "Boeing 747", capacity = 480, fuelBurn = (11304 / 60).toInt, speed = 880, range = 10920, price = 210_500_000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 3183, imageUrl = ""),
    Model("Boeing 747-200", "Boeing 747", capacity = 516, fuelBurn = (11563 / 60).toInt, speed = 880, range = 10200, price = 220_700_000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 3347, imageUrl = ""),
