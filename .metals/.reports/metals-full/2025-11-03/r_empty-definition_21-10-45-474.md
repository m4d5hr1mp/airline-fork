error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/LinkSimulation.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/LinkSimulation.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/model/scala/concurrent/duration.
	 -com/patson/data/scala/concurrent/duration.
	 -scala/collection/mutable/scala/concurrent/duration.
	 -scala/concurrent/duration.
	 -scala/Predef.scala.concurrent.duration.
offset: 274
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/LinkSimulation.scala
text:
```scala
package com.patson
...
import scala.concurrent.dura@@tion.Duration
