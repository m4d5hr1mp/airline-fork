error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Airport.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Airport.scala
...
offset: 17118
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Airport.scala
text:
```scala
...
//  }
  ...
  def slotFee(airplaneModel: Model, airline: Airline): Int = {
    ...
    val atcFee = airplaneModel.airplaneType match {
      ...
      case Model.Ty@@pe.LARGE => (5.0 * airplaneModel.capacity).toInt    // Large pay from 250x5=1250 to 360x5=1800 (this includes all smaller wide-bodies)
