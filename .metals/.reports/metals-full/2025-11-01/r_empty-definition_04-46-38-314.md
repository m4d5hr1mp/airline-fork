error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/DemandGenerator.scala:income.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/DemandGenerator.scala
empty definition using pc, found symbol in pc: income.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/model/fromAirport/income.
	 -com/patson/model/fromAirport/income#
	 -com/patson/model/fromAirport/income().
	 -scala/collection/parallel/CollectionConverters.fromAirport.income.
	 -scala/collection/parallel/CollectionConverters.fromAirport.income#
	 -scala/collection/parallel/CollectionConverters.fromAirport.income().
	 -FlightType.fromAirport.income.
	 -FlightType.fromAirport.income#
	 -FlightType.fromAirport.income().
	 -scala/collection/JavaConverters.fromAirport.income.
	 -scala/collection/JavaConverters.fromAirport.income#
	 -scala/collection/JavaConverters.fromAirport.income().
	 -fromAirport/income.
	 -fromAirport/income#
	 -fromAirport/income().
	 -scala/Predef.fromAirport.income.
	 -scala/Predef.fromAirport.income#
	 -scala/Predef.fromAirport.income().
offset: 11777
...
//	      }
  ...
  def computeDemandBetweenAirports(fromAirport : Airport, toAirport : Airport, relationship : Int, passengerType : PassengerType.Value) : LinkClassValues = {
    ...
    if (fromAirport == toAirport || fromAirport.population == 0 || toAirport.population == 0 || distance <= MIN_DISTANCE) {
      ...
      val income = fromAirport.in@@come
