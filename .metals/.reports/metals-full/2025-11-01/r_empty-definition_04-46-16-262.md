error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/DemandGenerator.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/DemandGenerator.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/model/SHORT_HAUL_INTERNATIONAL.
	 -com/patson/model/SHORT_HAUL_INTERNATIONAL#
	 -com/patson/model/SHORT_HAUL_INTERNATIONAL().
	 -scala/collection/parallel/CollectionConverters.SHORT_HAUL_INTERNATIONAL.
	 -scala/collection/parallel/CollectionConverters.SHORT_HAUL_INTERNATIONAL#
	 -scala/collection/parallel/CollectionConverters.SHORT_HAUL_INTERNATIONAL().
	 -FlightType.SHORT_HAUL_INTERNATIONAL.
	 -FlightType.SHORT_HAUL_INTERNATIONAL#
	 -FlightType.SHORT_HAUL_INTERNATIONAL().
	 -scala/collection/JavaConverters.SHORT_HAUL_INTERNATIONAL.
	 -scala/collection/JavaConverters.SHORT_HAUL_INTERNATIONAL#
	 -scala/collection/JavaConverters.SHORT_HAUL_INTERNATIONAL().
	 -SHORT_HAUL_INTERNATIONAL.
	 -SHORT_HAUL_INTERNATIONAL#
	 -SHORT_HAUL_INTERNATIONAL().
	 -scala/Predef.SHORT_HAUL_INTERNATIONAL.
	 -scala/Predef.SHORT_HAUL_INTERNATIONAL#
	 -scala/Predef.SHORT_HAUL_INTERNATIONAL().
offset: 10014
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/DemandGenerator.scala
text:
```scala
package com.patson
  ...
  def computeDemandBetweenAirports(fromAirport : Airport, toAirport : Airport, relationship : Int, passengerType : PassengerType.Value) : LinkClassValues = {
    ...
    if (fromAirport == toAirport || fromAirport.population == 0 || toAirport.population == 0 || distance <= MIN_DISTANCE) {
      ...
      adjustedDemand += baseDemand * (flightType match {
        ...
        case SHO@@RT_HAUL_INTERNATIONAL | MEDIUM_HAUL_INTERNATIONAL | SHORT_HAUL_INTERCONTINENTAL | MEDIUM_HAUL_INTERCONTINENTAL => 0
