error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Pricing.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Pricing.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -FlightType.priceBracket._1.
	 -FlightType.priceBracket._1#
	 -FlightType.priceBracket._1().
	 -priceBracket/_1.
	 -priceBracket/_1#
	 -priceBracket/_1().
	 -scala/Predef.priceBracket._1.
	 -scala/Predef.priceBracket._1#
	 -scala/Predef.priceBracket._1().
offset: 954
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Pricing.scala
text:
```scala
...
object Pricing {
  ...
  def computeStandardPrice(distance : Int, flightType : FlightType, linkClass : LinkClass) : Int = {
    ...
    price = ((flightType match {
      case SHORT_HAUL_INTERNATIONAL | MEDIUM_HAUL_INTERNATIONAL | LONG_HAUL_INTERNATIONAL => (price * INTERNATIONAL_PRICE_MULTIPLIER)
