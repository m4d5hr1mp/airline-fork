error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/airplane/ModelDiscount.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/airplane/ModelDiscount.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/model/airplane/Model.Type.MEDIUM.
	 -com/patson/model/airplane/Model.Type.MEDIUM#
	 -com/patson/model/airplane/Model.Type.MEDIUM().
	 -MEDIUM.
	 -MEDIUM#
	 ...
	 -scala/Predef.MEDIUM().
offset: 2847
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/airplane/ModelDiscount.scala
text:
```scala
