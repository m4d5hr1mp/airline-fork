error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/airplane/Model.scala:`<none>`.
...
case class Model(
  ...
  // weekly fixed cost
  val baseMaintenanceCost: Int = category match {
...
object Model {
  ...
  object Category extends Enumeration {
    type Category = Value
    val LIGHT, REGIONAL, MEDIUM, LARGE, SUPERSONIC = V@@alue
    val grouping = Map(
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, manufacturer = Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Ilyushin Il-18", "Ilyushin Il-18", capacity = 120, fuelBurn = (120 * 4.2).toInt, speed = 625, range = 3700, price = 31_000_000, lifespan = 25 * 52, constructionTime = 8, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 1350),
    Model("Yakovlev Yak-42", "Yakovlev", capacity = 120, fuelBurn = (120 * 4.5).toInt, speed = 810, range = 4000, price = 31_000_000, lifespan = 25 * 52, constructionTime = 8, Manufacturer("Yakovlev", countryCode = "RU"), runwayRequirement = 1700),
    ...
    Model("Ilyushin Il-62", "Ilyushin Il-62", capacity = 186, fuelBurn = (186 * 4.8).toInt, speed = 900, range = 10000, price = 60_000_000, lifespan = 25 * 52, constructionTime = 24, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 2300),
