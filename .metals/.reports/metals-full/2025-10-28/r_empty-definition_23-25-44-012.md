error id: file://<WORKSPACE>/airline-web/app/controllers/ProfileApplication.scala:`<none>`.
file://<WORKSPACE>/airline-web/app/controllers/ProfileApplication.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/model/model/price.
	 -com/patson/model/model/price#
	 -com/patson/model/model/price().
	 -com/patson/model/airplane/model/price.
	 -com/patson/model/airplane/model/price#
	 -com/patson/model/airplane/model/price().
	 -play/api/libs/json/model/price.
	 -play/api/libs/json/model/price#
	 -play/api/libs/json/model/price().
	 -play/api/mvc/model/price.
	 -play/api/mvc/model/price#
	 -play/api/mvc/model/price().
	 -model/price.
	 -model/price#
	 -model/price().
	 -scala/Predef.model.price.
	 -scala/Predef.model.price#
	 -scala/Predef.model.price().
offset: 1651
uri: file://<WORKSPACE>/airline-web/app/controllers/ProfileApplication.scala
text:
```scala
package controllers
