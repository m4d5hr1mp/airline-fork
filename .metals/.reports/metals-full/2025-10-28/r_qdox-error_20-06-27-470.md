error id: file://<WORKSPACE>/airline-web/app/controllers/SearchUtil.java
file://<WORKSPACE>/airline-web/app/controllers/SearchUtil.java
...
```java
offset: 0
uri: file://<WORKSPACE>/airline-web/app/controllers/SearchUtil.java
text:
```scala
@@
```
...
com.thoughtworks.qdox.parser.impl.Parser.yyerror(Parser.java:2025)
	...
	scala.meta.internal.metals.MetalsLspService.$anonfun$definitionOrReferences$1(MetalsLspService.scala:1689)
	scala.Option.map(Option.scala:242)
	scala.meta.internal.metals.MetalsLspService.definitionOrReferences(MetalsLspService.scala:1685)
	scala.meta.internal.metals.MetalsLspService.$anonfun$definition$1(MetalsLspService.scala:943)
	scala.meta.internal.metals.CancelTokens$.future(CancelTokens.scala:38)
	scala.meta.internal.metals.MetalsLspService.definition(MetalsLspService.scala:942)
...
QDox parse error in file://<WORKSPACE>/airline-web/app/controllers/SearchUtil.java