error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Bank.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Bank.scala
...
non-local guesses:
	 ...
	 -scala/Predef().
offset: 948
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/model/Bank.scala
text:
```scala
