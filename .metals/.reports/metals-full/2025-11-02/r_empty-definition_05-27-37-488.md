error id: file://<WORKSPACE>/airline-web/app/controllers/BankApplication.scala:`<none>`.
file://<WORKSPACE>/airline-web/app/controllers/BankApplication.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/model/loan/airlineId.
	 -com/patson/model/loan/airlineId#
	 -com/patson/model/loan/airlineId().
	 -play/api/libs/json/loan/airlineId.
	 -play/api/libs/json/loan/airlineId#
	 -play/api/libs/json/loan/airlineId().
	 -play/api/mvc/loan/airlineId.
	 -play/api/mvc/loan/airlineId#
	 -play/api/mvc/loan/airlineId().
	 -loan/airlineId.
	 -loan/airlineId#
	 -loan/airlineId().
	 -scala/Predef.loan.airlineId.
	 -scala/Predef.loan.airlineId#
	 -scala/Predef.loan.airlineId().
offset: 3570
uri: file://<WORKSPACE>/airline-web/app/controllers/BankApplication.scala
text:
```scala
package controllers
...
class BankApplication @Inject()(cc: ControllerComponents) extends AbstractController(cc) {
  ...
  def repayLoan(airlineId : Int, loanId : Int) = AuthenticatedAirline(airlineId) { request =>
    ...
    BankSource.loadLoanById(loanId) match {
      case Some(loan) => { 
        if (loan.airline@@Id != request.user.id) {
