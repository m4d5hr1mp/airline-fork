error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/LoanInterestRateSimulation.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/LoanInterestRateSimulation.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/patson/data/BigDecimal#
	 -BigDecimal#
	 -scala/Predef.BigDecimal#
offset: 2284
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/LoanInterestRateSimulation.scala
text:
```scala
package com.patson
...
object LoanInterestRateSimulation {
  ...
  val MAX_DELTA : BigD@@ecimal = 0.01
