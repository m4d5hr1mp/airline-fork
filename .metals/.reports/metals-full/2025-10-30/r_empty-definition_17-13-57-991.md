error id: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/init/GeoDataGenerator.scala:`<none>`.
file://<WORKSPACE>/airline-data/src/main/scala/com/patson/init/GeoDataGenerator.scala
...
offset: 13096
uri: file://<WORKSPACE>/airline-data/src/main/scala/com/patson/init/GeoDataGenerator.scala
text:
```scala
      ...
      if (potentialAirports.size == 1) {
        ...
        val airportWeights = validAirports.foldRight(List[(Airport, Int)]()) {
          case (Tuple2(airport, distance), airportWeightList) =>
            ...
            (airport, thisAirportWeight) :: airp@@ortWeightList
